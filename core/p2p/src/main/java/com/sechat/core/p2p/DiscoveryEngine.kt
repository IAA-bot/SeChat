...
class DiscoveryEngine(private val context: Context) {
    ...
    fun registerService(port: Int): Flow<NsdRegistrationState> = callbackFlow {
    ...
    fun discoverServices(): Flow<NsdDiscoveredService> = callbackFlow {
    ...
    fun resolveService(info: NsdServiceInfo): Flow<NsdResolvedService> = callbackFlow {
